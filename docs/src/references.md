...
- [Sigma Taxonomy](https://github.com/SigmaHQ/sigma-specification/blob/main/specification/sigma-appendix-taxonomy.md)
- [Sigma Modifiers](https://github.com/SigmaHQ/sigma-specification/blob/main/specification/sigma-appendix-modifiers.md)
- [`auditd`](https://www.redhat.com/en/blog/configure-linux-auditing-auditd)
